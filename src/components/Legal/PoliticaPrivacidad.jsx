...
const PoliticaPrivacidad = () => {
  return (
    <Layout>
      ...
      <p>Cuando usas Closy, podemos recopilar:</p>
      <ul>
      ...
      <ul>
        <li>Ofrecerte las funciones principales de Closy (como probar ropa virtualmente).</li>
      ...
      <ul>
        <li>Proveedores de servicios que nos ayudan a operar Closy (por ejemplo, servidores o procesamiento de imágenes).</li>
      ...
      <p>Guardamos tus datos mientras tengas una cuenta activa en Closy o mientras sean necesarios para proporcionarte nuestros servicios. Puedes solicitar su eliminación en cualquier momento.</p>
